...
<head>
   ...
   <!-- 
    ...
    <link rel="stylesheet" href="css/estilo-usuarios.css">
    <link rel="stylesheet" href="css/estilo-agregarusuario.css">
    ../../public/css/estilo-login.css
   -->
    <link rel="stylesheet" href="{{asset('css/estilo-login.css')}}" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light bg">
    ...
    -->
    <button class="navbar-toggler boton-pequeño" type="button" data-toggle="collapse"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="field">
                                    ...
                                    <input type="text" required>
                                    <input  class="rojo" type="hidden" name="apellido">
                                </div>
                            </div>
                        </div>
                        <div class="field">
